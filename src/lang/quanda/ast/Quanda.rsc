...
data Statement
  ...
  | \switch(Expression exp, list[tuple[Expression, Statement]] cases, list[Statement] otherwise)
  | \cond(list[tuple[Expression, Statement]] cases, list[Statement] otherwise)
